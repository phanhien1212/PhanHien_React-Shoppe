            ...
            <div className="grid wide">
                <nav className="header__navbar hide-on-mobile-tablet">
                    <ul className="header__navbar-list">
                        <div className="header__navbar-item header__navbar-item-separate">
                            Kênh người bán
                        </div>
                        <li className="header__navbar-item header__navbar-item-has-qr header__navbar-item-separate">
                            ...
                            <div className="header__qr">
                                <img src={require('../../Images/a5e589e8e118e937dc660f224b9a1472.png')} alt="QR code" className="header__qr-img" />
                                <div className="header__qr-apps">
                                    <a className="header__qr-link">
                                        <img src={require('../../Images/google_play.png')} alt="Google Play" className="header__qr-dowload-img" />
                                    </a>
                                    <a className="header__qr-link">
                                        <img src={require('../../Images/app_store.png')} alt="App Store" className="header__qr-dowload-img" />
                                    </a>
                                </div>
                            </div>
                        </li>
                    ...
                    <ul className="header__navbar-list">
                                ...
                                <ul className="header__notify-list">
                                    <li className="header__notify-item header__notify-item--viewed">
                                        <a href className="header__notify-link">
                                            <img src={require('../../Images/ao1mattruoc.png')} alt className="header__notify-img" />
                        ...
                        <li id="register-item" className="header__navbar-item header__navbar-item-separate" data-bs-toggle="modal" data-bs-target="#exampleModal1">Đăng Ký</li>
                        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" >
                                <div class="modal-content" style={{ width: 400, marginTop: 75, marginLeft: 20 }} >
                                    ...
                                    <form id="register-form" class="auth-form">
                                        ...
                                        <div class="auth-form__socials" >
                                            <a href="" class="auth-form__socials--facebook btn btn--size-s btn--with-icon" style={{ display: "block" }}>
                                                <i class="auth-form__socials-icon fab fa-facebook-square"></i>
                                                <span class="auth-form__socials-title">
                                                    Kết nối với Facebook
                                                </span>
                                            </a>
                                            <a href="" class="auth-form__socials--google btn btn--size-s btn--with-icon" style={{ display: "block" }}>
                        ...
                        <li id="login-item" className="header__navbar-item" data-bs-toggle="modal" data-bs-target="#exampleModal2">Đăng Nhập</li>
                        <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content" style={{ width: 400, marginTop: 145, marginLeft: 20 }} >
                    ...
                    <ul className="nav__mobile-list">
                        ...
                        <ul className="category-list">
                            <li className="category-item category-item--active">
                                <a href className="category-item__link">Đồ bán chạy hôm nay</a>
                            </li>
                            <li className="category-item">
                                <a href className="category-item__link">Bình giữ nhiệt</a>
                            </li>
                            <li className="category-item">
                                <a href className="category-item__link">Bộ lắp ghép Minecraft</a>
                            </li>
                            <li className="category-item">
                                <a href className="category-item__link">Hộp bút chì Creeper</a>
                            </li>
                            <li className="category-item">
                                <a href className="category-item__link">Túi khăn tắm 3 hộp</a>
                            </li>
                            <li className="category-item">
                                <a href className="category-item__link">Balo Creeper</a>
                            </li>
                            <li className="category-item">
                                <a href className="category-item__link">Móc khóa Diamond Word</a>
                            </li>
                            <li className="category-item">
                                <a href className="category-item__link">Bộ lắp ghép Bàn chế tạo</a>
                            </li>
                            <li className="category-item">
                                <a href className="category-item__link">Hộp thẻ bài 4 người</a>
                            </li>
                            <li className="category-item">
                                <a href className="category-item__link">Cốc lạc đà Llama</a>
                            </li>
                        </ul>
                    </ul>
                ...
                <div className="header-with-search">
                    ...
                    <div className="header__logo hide-on-mobile-tablet">
                        <a href="./" className="header__logo-link">
                            <svg viewBox="0 0 192 65" className="header__logo-img shopee-svg-icon header-with-search__shopee-logo icon-shopee-logo">
                                <g fillRule="evenodd">
                    ...
                    <div className="header__cart hide-on-mobile-tablet">
                        <div className="header__cart-wrap">
                            ...
                            <div className="header__cart-list">
                                ...
                                <ul className="header__cart-list-item">
                                    ...
                                    <li title="Mũ chụp ngược Minecraft Dungeons" className="header__cart-item">
                                        <div className="header__cart-img-wrapper">
                                            <img src={require('../../Images/ao1mattruoc.png')} className="header__cart-img" />
                                        </div>
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <div className="header__cart-item-name">Mũ chụp ngược
                                                </div>
                                ...
                                <Link to='/cart'><button className="header__cart-view-cart btn btn--primary">Xem giỏ hàng</button></Link>
                            </div>
                        </div>
                    </div>
                </div>
